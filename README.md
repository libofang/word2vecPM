...
It can be used to generate linear and dependency context type, as well as two context representations. One can also choose the generated collection (for GSG or GBOW).
